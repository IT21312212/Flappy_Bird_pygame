...
def create_pipe():
    random_pipe_posi = random.choice(pipe_height)
    bottom_pipe = pipe_surface.get_rect(midtop = (350,random_pipe_posi))
    top_pipe = pipe_surface.get_rect(midbottom = (350,random_pipe_posi -150))
...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = score_surface.get_rect(center = (110,420))
...
bird_frams = [bird_downflap,bird_midflap,bird_upflap]
bird_index = 0
bird_surface =  bird_frams[bird_index]
bird_rect = bird_surface.get_rect(center = (50,256))
...
# scale imagwe to screen dimensions
